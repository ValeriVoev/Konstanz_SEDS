...
The main contribution of Zhou et al. is the **alternating** least squares (ALS) approach which alternates between updates of the \(U\) and \(V\) matrices (keeping \(V\) and \(U\) fixed, correspondingly). They also show how the problem can be parallelized (showing a Matlab implementation) which allows solving problems of huge dimensions (the Netflix dataset has over 100 million ratings by more than 480,000 users of close to 18,000 movies).
